...
Widget deliveryProofImages(OrderModel model) {
  ...
  return (widget.model?.invoice != null && widget.model!.invoice!.isNotEmpty)
      ? Card(
          elevation: 0,
          child: InkWell(
            child: ListTile(
            ...
            onTap: () async {
              ...
              if (status == PermissionStatus.granted || isLatestOs) {
                ...
                showInvoiceDownloadDialog(context, filePath, widget.model!.id!);
              } else {
                setSnackbar(
                    getTranslated(context, "PERMISSION_NOT_ALLOWED")!, context);
              }
            },
          ),
        )
...
void showInvoiceDownloadDialog(BuildContext context, String filePath, String targetFileName) {
  showDialog(
    context: context,
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              "Your invoice has been saved as 'Invoice_$targetFileName' in your download folder.",
              textAlign: TextAlign.center,
